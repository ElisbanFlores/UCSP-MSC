...
#include "CPattern.h"
#include "CDynamicalDifferentialEvolutionBoost.h"
...
// CDynamicalDifferentialEvolutionBoost < tipo de patron, numero de poblacion, funcion Fitness>
// Al llamar
...
typedef CDynamicalDifferentialEvolutionBoost<pattern_t,5000,fitness_t,MINIMUM> evolution_t;
*/
...
typedef FitnessAckley<pattern_t> fitness_t;
typedef CDynamicalDifferentialEvolutionBoost<pattern_t, 100, fitness_t, MINIMUM> evolution_t;
*/
...
typedef CDynamicalDifferentialEvolutionBoost<pattern_t,200,fitness_t,MINIMUM> evolution_t;
*/
...
typedef FitnessSchwefel<pattern_t> fitness_t;
typedef CDynamicalDifferentialEvolutionBoost<pattern_t,17500, fitness_t, MINIMUM> evolution_t;
*/
...
typedef CDynamicalDifferentialEvolutionBoost<pattern_t,2000,fitness_t,MAXIMUM> evolution_t;
